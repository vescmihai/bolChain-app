...
import 'package:bolchain/pages/terms_conditions_page.dart'; // Importa la página de términos y condiciones
...
class OnboardingPage extends StatelessWidget {
  ...
  onPressed: () {
    Navigator.pushNamed(context, TermsConditionsPage.route).then((_) {
      // Después de aceptar los términos, proceder con la creación de la cuenta
      context.read<OnboardingPageUiHelper>().createAccount().then(
